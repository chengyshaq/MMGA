...
class nuswideloader(data.Dataset):
    def __init__(self, root='/home/yscheng/px/multi-label-ood-master-jointenergy/nobackup-slow/nus-wide/', split="train",
    ...
    def __getitem__(self, index):
        path = "/home/yscheng/px/multi-label-ood-master-jointenergy/nobackup-slow/nus-wide/"
